...
// sha256: b33865f9bcb546c7c5c480a17b6662a1fc3a2604c25a58868fa26a32230dc
use ast::Literals;
...
mod __parse__Term {
    ...
    impl TermParser {
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<Literals, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
    ...
    ) -> Option<Result<Literals,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
